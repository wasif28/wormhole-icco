...
describe("Testnet ICCO Sales", () => {
  ...
  // TODO: use deployer key so we can update kyc authority on Conductor
  // const deployer = new ethers.Wallet("0x" + process.env.DEPLOYER_PRIVATE_KEY);
  ...
  describe("Conduct Successful Sale", () => {
    ...
    it("Conductor Owner Changes KYC Authority for Sale", async () => {
      // TODO: use deployer wallet to execute updateSaleAuthority
      //
      // Then consume VAA on Solana contributor program and verify
      // KYC authority equals what we expect.
    });
  ...
  describe("Conduct Aborted Sale", () => {
    ...
    it("Orchestrator Attempts to Seal Sale on Conductor", async () => {
      // TODO
    });

    it("Orchestrator Aborts Sale on Solana Contributor", async () => {
      // TODO
    });
